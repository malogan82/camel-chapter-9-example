...
public class SpringTest {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String response15 = producerTemplate.requestBodyAndHeader("direct:start-validate-simple","TEST","bar",200,String.class);
			LOGGER.info(String.format("RESPONSE ----------> %s",response15));
			try {
				Thread.sleep(10000);
				main.stop();
			} catch (Exception e) {
